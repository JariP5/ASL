...
import 'package:ASL/Learn/ui/box_widget.dart';
import 'package:ASL/Learn/ui/camera_view.dart';
import 'package:ASL/Learn/ui/camera_view_copy.dart';
...
/// [BewView] stacks [CameraViewCopy] and [BoxWidget]s with bottom sheet for stats
class BewView extends StatefulWidget {
  @override
  _BewViewState createState() => _BewViewState();
}

class _BewViewState extends State<BewView> {
                ...
                child: Container(
                  ...
                  child: Scaffold(
                      ...
                      body: Stack(
                        children: <Widget>[
                          // Camera View
                          CameraViewCopy(resultsCallback, statsCallback),
